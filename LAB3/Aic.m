function [ C ] = Aic( in_cond, nelemx, nelemy, nodes, elements )
...
for e = 1:totelem
        ...
        for i = elements(e, :)
            ...
            for j = elements(e, :)
                ...
                k1 = PHI(1,ii)*UU(jj)*PHI(1,jj);
                k2 = PHI(2,ii)*UU(jj)*PHI(2,jj);
                k3 = PHI(3,ii)*UU(jj)*PHI(3,jj);
                k4 = PHI(4,ii)*UU(jj)*PHI(4,jj);
